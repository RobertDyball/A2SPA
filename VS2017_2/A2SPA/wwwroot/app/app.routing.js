...
var appRoutes = [
    ...
    { path: 'demo', component: demo_component_1.DemoComponent, data: { title: 'Demo' } }
];
exports.routing = router_1.RouterModule.forRoot(appRoutes);
exports.routedComponents = [about_component_1.AboutComponent, index_component_1.IndexComponent, contact_component_1.ContactComponent, demo_component_1.DemoComponent, login_component_1.LoginComponent, register_component_1.RegisterComponent, changePassword_component_1.ChangePasswordComponent, manage_component_1.ManageComponent];

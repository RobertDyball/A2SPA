...
var appRoutes = [
    ...
    { path: 'changePassword', component: changePassword_component_1.ChangePasswordComponent, data: { title: 'Change Password' }, canActivate: [authGuardService_1.AuthGuard] },
    { path: 'manage', component: manage_component_1.ManageComponent, data: { title: 'Manage Account' }, canActivate: [authGuardService_1.AuthGuard] },
    { path: 'about', component: about_component_1.AboutComponent, data: { title: 'About' }, canActivate: [authGuardService_1.AuthGuard] },
